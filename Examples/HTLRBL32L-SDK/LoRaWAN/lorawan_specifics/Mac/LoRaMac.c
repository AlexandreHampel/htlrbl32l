 ...
 *              (______/|_____)_|_|_||_| |_____)\____)_| |_|
 *
...
static void OnRadioRxTimeout( void )
{
//	  printf("callback LoRaWAN Rx Timeout\n");
    ...
    while( macIndex < commandsSize )
    {
        ...
        switch( payload[macIndex++] )
        {
            ...
            case SRV_MAC_RX_PARAM_SETUP_REQ:
            {
				...
				printf("Received RxParams from gateway - Rx2Channel.Datarate: %d, Rx2Channel.Frequency: %u, Rx1DrOffset: %d\n",rxParamSetupReq.Datarate,rxParamSetupReq.Frequency,rxParamSetupReq.DrOffset);
            ...
            case SRV_MAC_NEW_CHANNEL_REQ:
            {
				...
				printf("newchannelID rqst:%d\n",newChannelReq.ChannelId);
...
LoRaMacStatus_t LoRaMacInitialization( LoRaMacPrimitives_t* primitives, LoRaMacCallback_t* callbacks, LoRaMacRegion_t region )
{
    ...
    lrWanVersion.Fields.Revision = 2;
